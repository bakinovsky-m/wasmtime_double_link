    ...
    pub mod wasi {
        pub mod cli {
            ...
            pub mod environment {
                ...
                #[doc(hidden)]
                pub(crate) use __export_wasi_cli_environment_0_2_3_cabi;
...
macro_rules! __export_example_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::cli::environment::__export_wasi_cli_environment_0_2_3_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:malicious-wasi-cli-environment:example:encoded world"
)]
#[doc(hidden)]
...
A\x02\x01B\x0a\x01o\x02ss\x01p\0\x01@\0\0\x01\x04\0\x0fget-environment\x01\x02\x01\
ps\x01@\0\0\x03\x04\0\x0dget-arguments\x01\x04\x01ks\x01@\0\0\x05\x04\0\x0biniti\
al-cwd\x01\x06\x04\0\x1awasi:cli/environment@0.2.3\x05\0\x04\00component:malicio\
us-wasi-cli-environment/example\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\0G\x09pro\

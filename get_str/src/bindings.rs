...
pub unsafe fn _export_get_str_cabi<T: Guest>() -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let result0 = T::get_str();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_get_str<T: Guest>(arg0: *mut u8) {
    let l0 = *arg0.add(0).cast::<*mut u8>();
    let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
    _rt::cabi_dealloc(l0, l1, 1);
}
pub trait Guest {
    fn get_str() -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_example_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "get-str")] unsafe extern "C" fn
        export_get_str() -> * mut u8 { unsafe { $($path_to_types)*::
        _export_get_str_cabi::<$ty > () } } #[unsafe (export_name = "cabi_post_get-str")]
        unsafe extern "C" fn _post_return_get_str(arg0 : * mut u8,) { unsafe {
        $($path_to_types)*:: __post_return_get_str::<$ty > (arg0) } } };
    };
}
#[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:get-str:example:encoded world"
)]
#[doc(hidden)]
...
al-cwd\x01\x06\x03\0\x1awasi:cli/environment@0.2.3\x05\0\x01@\0\0s\x04\0\x07get-\
str\x01\x01\x04\0\x19component:get-str/example\x04\0\x0b\x0d\x01\0\x07example\x03\
